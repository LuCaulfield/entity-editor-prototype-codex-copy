  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4">
      ...
      <button
        type="button"
        onClick={() => onAddSet(id)}
        className="mt-3 w-full rounded-xl border border-dashed border-slate-300 py-2 text-sm text-slate-500 hover:border-teal-400 hover:text-teal-600 transition"
      >
        + Add set
      </button>
    </div>
